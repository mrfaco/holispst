...
class MateriaService(MateriaServiceBase):
    ...
    def SaveMateria(self,materiaInput):
        self.materiasDomainService.SaveMateria(materiaInput.ToDomainForNew())

    def UpdateMateria(self,MateriaInput,Id):
        self.materiasDomainService.UpdateMateria(MateriaInput.ToDomainForUpdate(Id))
